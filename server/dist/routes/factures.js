...
import { getAllFactures, getFactureById, getFacturesByUserId, getAllFacturesByCompanyId, getAllFacturesByCompanyIdAndPagination, postFacture, patchFactureTotalAmount, deleteFacture, } from '../controllers/factures.js';
